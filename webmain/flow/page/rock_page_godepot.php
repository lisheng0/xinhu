...
$(document).ready(function(){
	{params}
	var modenum = 'godepot',modename='存放地管理',isflow=0,modeid='73',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"depotname","name":"\u5b58\u653e\u5730\u70b9","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"cgname","name":"\u7ba1\u7406\u5458","fieldstype":"changeusercheck","ispx":"0","isalign":"0","islb":"1"},{"fields":"depotnum","name":"\u5b58\u653e\u70b9\u7f16\u53f7","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"depotaddress","name":"\u8be6\u7ec6\u5730\u5740","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"sort","name":"\u6392\u5e8f\u53f7","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"depotexplain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'存放地管理('+nowtabs.name+')',
				cont:'存放地管理('+nowtabs.name+')的列表的',
				explain:'订阅[存放地管理]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorugodepot',url:'flow,input,daoru,modenum=godepot',icons:'plus',name:'导入存放地管理'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"存放地点",dataIndex:"depotname"},{text:"管理员",dataIndex:"cgname"},{text:"存放点编号",dataIndex:"depotnum"},{text:"详细地址",dataIndex:"depotaddress"},{text:"排序号",dataIndex:"sort"},{text:"说明",dataIndex:"depotexplain"},{
