...
$(document).ready(function(){
	...
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"applydt","name":"\u7533\u8bf7\u65e5\u671f","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"type","name":"\u7c7b\u578b","fieldstype":"fixed","ispx":"0","isalign":"0","islb":"1"},{"fields":"custname","name":"\u4f9b\u5e94\u5546\u540d\u79f0","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"},{"fields":"custid","name":"\u4f9b\u5e94\u5546ID","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"0"},{"fields":"discount","name":"\u4f18\u60e0\u4ef7\u683c","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"money","name":"\u91c7\u8d2d\u91d1\u989d","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"state","name":"\u5165\u5e93\u72b6\u6001","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"申请日期",dataIndex:"applydt"},{text:"说明",dataIndex:"explain"},{text:"类型",dataIndex:"type"},{text:"供应商名称",dataIndex:"custname"},{text:"优惠价格",dataIndex:"discount"},{text:"采购金额",dataIndex:"money"},{text:"入库状态",dataIndex:"state",sortable:true},{text:"状态",dataIndex:"statustext"},{
