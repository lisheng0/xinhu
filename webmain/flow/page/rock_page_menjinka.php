...
*	来源：流程模块→表单元素管理→[模块.门禁卡权限申请]→生成列表页
*/
...
$(document).ready(function(){
	{params}
	var modenum = 'menjinka',modename='门禁卡权限申请',isflow=1,modeid='81',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"quanxian","name":"\u6743\u9650\u9009\u62e9","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"1"},{"fields":"applydt","name":"\u7533\u8bf7\u65e5\u671f","fieldstype":"date","ispx":"0","isalign":"0","islb":"1"},{"fields":"bumen","name":"\u6240\u5728\u90e8\u95e8","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u7533\u8bf7\u539f\u56e0","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"floor_1","name":"1\u53f7\u697c\u6743\u9650","fieldstype":"checkboxall","ispx":"0","isalign":"0","islb":"1"},{"fields":"floor_5","name":"5\u53f7\u697c\u6743\u9650","fieldstype":"checkboxall","ispx":"0","isalign":"0","islb":"1"},{"fields":"floor_6","name":"6\u53f7\u697c\u6743\u9650","fieldstype":"checkboxall","ispx":"0","isalign":"0","islb":"1"},{"fields":"floor_7","name":"7\u53f7\u697c\u6743\u9650","fieldstype":"checkboxall","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'门禁卡权限申请('+nowtabs.name+')',
				cont:'门禁卡权限申请('+nowtabs.name+')的列表的',
				explain:'订阅[门禁卡权限申请]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_menjinka|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistmenjinka = a;
			addtabs({num:'daorumenjinka',url:'flow,input,daoru,modenum=menjinka',icons:'plus',name:'导入门禁卡权限申请'});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('bWVuamlu'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"权限选择",dataIndex:"quanxian"},{text:"申请日期",dataIndex:"applydt"},{text:"所在部门",dataIndex:"bumen"},{text:"申请原因",dataIndex:"explain"},{text:"1号楼权限",dataIndex:"floor_1"},{text:"5号楼权限",dataIndex:"floor_5"},{text:"6号楼权限",dataIndex:"floor_6"},{text:"7号楼权限",dataIndex:"floor_7"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewmenjinka_{rand}').bootstable(bootparams);
	c.init();
