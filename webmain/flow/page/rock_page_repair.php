...
$(document).ready(function(){
	{params}
	var modenum = 'repair',modename='设备报修',isflow=1,modeid='62',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"assetm","name":"\u8bbe\u5907\u540d\u79f0","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"weizhi","name":"\u8bbe\u5907\u6240\u5728\u4f4d\u7f6e","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"reason","name":"\u95ee\u9898\u63cf\u8ff0","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"iswx","name":"\u9700\u8981\u5916\u4fee","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"reasons","name":"\u5b9e\u9645\u539f\u56e0","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"money","name":"\u7ef4\u4fee\u91d1\u989d","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"wxname","name":"\u7ef4\u4fee\u516c\u53f8","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"0"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'设备报修('+nowtabs.name+')',
				cont:'设备报修('+nowtabs.name+')的列表的',
				explain:'订阅[设备报修]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorurepair',url:'flow,input,daoru,modenum=repair',icons:'plus',name:'导入设备报修'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"设备名称",dataIndex:"assetm"},{text:"设备所在位置",dataIndex:"weizhi"},{text:"问题描述",dataIndex:"reason"},{text:"需要外修",dataIndex:"iswx"},{text:"实际原因",dataIndex:"reasons"},{text:"维修金额",dataIndex:"money",sortable:true},{text:"维修公司",dataIndex:"wxname"},{text:"状态",dataIndex:"statustext"},{
