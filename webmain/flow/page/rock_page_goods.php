...
$(document).ready(function(){
	{params}
	var modenum = 'goods',modename='物品',isflow=0,modeid='83',atype = params.atype,pnum=params.pnum;
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'物品('+nowtabs.name+')',
				cont:'物品('+nowtabs.name+')的列表的',
				explain:'订阅[物品]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_goods|input','flow',{'modeid':modeid});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('Z29vZHM:'),
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewgoods_{rand}').bootstable(bootparams);
	c.init();
